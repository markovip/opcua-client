...
MonitoredItem.prototype._on_value_changed = function(dataValue,indexRange) {
    ...
    if (hasChanged) {
        // copy dataVariant to make sure we have our own copy of the dataValue
...
MonitoredItem.prototype.recordValue = function (dataValue, indexRange) {
    ...
    //xx console.log("xxxx MonitoredItem.prototype.recordValue ",self.node.browseName.toString());
...
MonitoredItem.prototype._enqueue_notification = function(notification) {
    ...
    //xx console.log(" Enqueuing n",notification.toString());
