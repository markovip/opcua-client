...
function add_analog_data_items(addressSpace, parentFolder) {
    ...
    function _addAnalogDataItem(localParentFolder, dataType) {
    ...
    ["Double", "Float", "Int16", "UInt16", "Int32", "UInt32", "Int64", "UInt64", "Byte", "SByte"]
        .forEach(function (dataType) {
            _addAnalogDataItem(analogItemFolder, dataType);
        });
...
function add_eventGeneratorObject(engine, parentFolder)  {

    // add event generating method
...
build_address_space_for_conformance_testing = function (server_engine, options) {
    ...
    add_eventGeneratorObject(server_engine,simulationFolder);
};
